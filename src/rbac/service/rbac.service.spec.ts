...
describe('SecureRbacService', () => {
  ...
  describe('createRole', () => {
    ...
    it('should throw an error if the role already exists', async () => {
      ...
      await expect(service.createRole(createRoleDto)).rejects.toThrow(HttpException);
    });
  });
  ...
  describe('updateRole', () => {
    it('should update a role', async () => {
      ...
      const updatedRole = await service.updateRole(roleId, updateRoleDto);

      expect(updatedRole).toBeDefined();
      expect(updatedRole.name).toBe(updateRoleDto.name);
    ...
    it('should throw a NotFoundException if role not found', async () => {
      ...
      await expect(service.updateRole(roleId, updateRoleDto)).rejects.toThrow(NotFoundException);
    });
    ...
    it('should throw an error if permission to connect not found', async () => {
      ...
      await expect(service.updateRole(roleId, updateRoleDto)).rejects.toThrow(HttpException);
    });
  ...
  describe('createPermission', () => {
    it('should create a new permission', async () => {
      ...
      const createdPermission = await service.createPermission(createPermissionDto);
    ...
    it('should throw an error if the permission already exists', async () => {
      ...
      await expect(service.createPermission(createPermissionDto)).rejects.toThrow(HttpException);
    });
  });
